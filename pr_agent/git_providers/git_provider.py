...
class GitProvider(ABC):
    # cached original (user-written) PR description; set lazily by get_user_description
    ...
    def edit_comment_from_comment_id(self, comment_id: int, body: str) -> None:
        pass
    ...
    def _possible_headers(self) -> tuple:
    ...
    @abstractmethod
    def publish_inline_comments(self, comments: list[dict]) -> None:
        pass
    ...
    def calc_pr_statistics(self, pull_request_data: dict) -> dict:
        return {}
    ...
    def limit_output_characters(self, output: str, max_chars: int) -> str:
...
class IncrementalPR:
    def __init__(self, is_incremental: bool = False) -> None:
